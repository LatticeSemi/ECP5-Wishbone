...
// For Type0 Registers
`define INIT_REG_000  32'hAE531204
`define INIT_REG_008  32'h11800001
`define INIT_REG_00C  32'h00000000
`define	EN_BAR0
`define	EN_BAR1
`define INIT_REG_010  32'hFFFFE00C
`define INIT_REG_014  32'hFFFFFFFF
...
`define INIT_REG_02C  32'hAE531204
...
`define INIT_REG_104  32'h00002021
`define INIT_REG_108  32'h11191600
