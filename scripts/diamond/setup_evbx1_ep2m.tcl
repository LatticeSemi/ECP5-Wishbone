# ------------------------------------------------------------------------------
# 
#  File ID     : $Id: setup_evbx1_ep2m.tcl 43 2021-11-18 17:41:37Z  $
...
# ------------------------------------------------------------------------------
   ...
   #  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
set FPGA_TECH "ECP2M";
set project_name "evbx1_ep2m"
set project_impl "ae53"
set project_tech "ecp2m"
set target_name "evbx1_ep2m"
set fpga_device "LFE2M50E-5F672I"
...
prj_impl option {include path}  "$project_root/work/ip_express/evbx1_ep2m/pcie_x1_v5/pcie_eval/pcie_x1/src/params"
