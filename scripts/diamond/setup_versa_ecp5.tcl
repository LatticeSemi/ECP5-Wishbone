# ------------------------------------------------------------------------------
# 
#  File ID     : $Id: setup_versa_ecp5.tcl 41 2021-11-17 21:29:49Z  $
#  Generated   : $LastChangedDate: 2021-11-17 22:29:49 +0100 (Wed, 17 Nov 2021) $
...
prj_strgy set_value -strategy "Default" syn_force_gsr=False
   ...
   #  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sbp_design open -dsgn "$project_root/work/clarity/versa_ecp5/pcie_x1_e5/pcie_x1_e5.sbx"
sbp_resource remove -ip {pcie_x1_e5/x_cref}
sbp_resource remove -ip {pcie_x1_e5/x_pcie}
sbp_design save
sbp_design close
